...
const translations = {
  ...
  nl: {
    ...
    hero: {
      ...
      description: 'Wij zijn gespecialiseerd in het vervaardigen van hoogwaardige orthodontische apparatuur op maat gemaakt voor tandheelkundig specialisten, waarbij geavanceerd vakmanschap wordt gecombineerd met biologische zorg.',
      btnContact: 'Neem Contact Op',
      btnServices: 'Onze Services',
      card1Title: 'Precisie Vakmanschap',
      card1Desc: 'Op maat gemaakte orthodontische apparatuur gemaakt met uiterste nauwkeurigheid en aandacht voor biomechanische details.',
    ...
    whyUs: {
      ...
      card5Desc: 'Wij bouwen duurzame relaties op met uw praktijk op basis van betrouwbaarheid en vertrouwen.',
      ctaTitle1: 'UW CASUS.',
